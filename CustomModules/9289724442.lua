...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/YoGalaxyStar13/Whitelists/main/PlayerWhitelist.json", true))
end)
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/YoGalaxyStar13/GXForRoblox/wiki/Turning-on-Highlights")
